...
const MainApp = () => {
  ...
  const fetchMusicData = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error("Failed to fetch music data, Try Again !!! ");
      }
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col">
            <h4 className="text-center text-warning py-2">{message}</h4>
          </div>
        </div>
        <div className="row">
          <div className="col-12 py-5 text-center">
            ...
            <h4>By Searching your favourite Music in Your Language.</h4>
          </div>
        </div>
      </div>
      <div
