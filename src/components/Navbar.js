      ...
      <nav className="navbar navbar-dark navbar-expand-lg bg-dark sticky-top">
        <div className="container-fluid">
          <Link className="navbar-brand">
            {/* Wrap with Link component and add onClick for refreshing */}
            <i className="bi bi-spotify"></i> Spotify Beta
          </Link>
          <div>
            <button
              type="button"
          ...
          >
            ...
            <div style={{color:"white", paddingLeft:70}}> 
            <Link className="navbar-brand" to="/" onClick={handleRefresh}>
            {/* Wrap with Link component and add onClick for refreshing */}
